{ inputs, cell }: {
  configFile = {
    ...
    "leftwm/themes/current/theme.ron".source = inputs.self
    ...
    "leftwm/themes/current/down".source = inputs.self
      + "/configs/leftwm/down.sh";
    "tree-sitter/config.json".text = inputs.nixpkgs.lib.generators.toJSON { } {
    ...
    #       Type = "Application";
    #       Name = "Experience";
    #       Exec = "${inputs.cells.experience.packages.experience}/bin/experience";
    #     };
    #   };
  };
}
